...
export default function ContactPage() {
  return (
    <main className="bg-white min-h-screen flex flex-col justify-center px-6 md:px-24 py-24">
      ...
      <div className="max-w-4xl w-full">
             ...
             <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    ...
                    <span className="text-base text-zinc-400 font-sans ml-2 opacity-0 group-hover:opacity-100 transition-opacity">/azat-samatuly</span>
                  </a>
        ...
        <div className="mt-24 pt-12 border-t border-zinc-200">
           <p className="text-zinc-500 font-sans text-sm md:text-base max-w-lg leading-relaxed">
             Based in San Francisco. Seeking internships in growth, GTM, marketing, and product management. Available for immediate start.
           </p>
        </div>
      </div>
